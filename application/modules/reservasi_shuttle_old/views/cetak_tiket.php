      ...
      <div style="margin-bottom:20px;" >
        ...
        <div class="col-xs-offset-2 col-xs-8" style="margin-top:10px;">
          <table class="table">
            <tr>
              <td>
                <img src="<?php echo base_url()?>assets/icons/icon-funds.svg" style="width:50px;" class="click" onclick="go_show_proses()">
                <strong>Tunai</strong>
              </td>
              <td>
                <img src="<?php echo base_url()?>assets/icons/icon-debit-card.svg" style="width:50px;" class="click" id="pembayaran" data-id="2">
                <strong>Debit</strong>
              </td>
            </tr>
            <tr>
              <td>
                <img src="<?php echo base_url()?>assets/icons/icon-credit-card.svg" style="width:50px;" class="click" id="pembayaran" data-id="3">
                <strong>Kredit</strong>
              </td>
              <td>
                <img src="<?php echo base_url()?>assets/icons/icon-voucher.svg" style="width:50px;" class="click" id="pembayaran" data-id="4">
