...
?>
<div class="col-lg-offset-1 col-lg-11" style="margin-bottom:20px;padding-left:90px;">
  <div class="row">
<!--???????????????????????????????????????BARISPERTAMA??????????????????????????????????????????????????????-->
...
<div class="row">
 ...
 <div class="penumpang <?php echo cek_penumpang_info($kode_j,$tgl_req,14);?>">
      <div class="col-lg-3 passengger14" align="center" style="padding:10px  0 20px 0; margin:3px;">
        <div class="icon-bangku <?php echo cek_penumpang_status($kode_j,$tgl_req,14);?>" <?php echo cek_penumpang_data($kode_j,$tgl_req,14);?>><span class="infoSeat <?php echo cek_penumpang_seat($kode_j,$tgl_req,14);?>">14</span></div>
          <button class="btn-bangku btn btn-xs <?php echo cek_penumpang_button($kode_j,$tgl_req,14);?>"><?php echo cek_penumpang_nama($kode_j,$tgl_req,14)?></button>
        </div>
    </div>
    ...
    <div class="penumpang <?php echo cek_penumpang_info($kode_j,$tgl_req,13);?>">
      <div class="col-lg-3 passengger13" align="center" style="padding:10px  0 20px 0; margin:3px;">
        <div class="icon-bangku <?php echo cek_penumpang_status($kode_j,$tgl_req,13);?>" <?php echo cek_penumpang_data($kode_j,$tgl_req,13);?>><span class="infoSeat <?php echo cek_penumpang_seat($kode_j,$tgl_req,13);?>">13</span></div>
          <button class="btn-bangku btn btn-xs <?php echo cek_penumpang_button($kode_j,$tgl_req,11);?>"><?php echo cek_penumpang_nama($kode_j,$tgl_req,13)?></button>
        </div>
    </div>
