...
class Reservasi_go_show extends MY_Controller{
                ...
                if($this->input->post('kode_manifest') == TRUE):
                    ...
                    try {
                        if($post != TRUE) throw new Exception("Error Processing Request");
                            ...
                            $send['go_show'] = $this->booking_proses($post);
                            $send_customers   = $this->customers_reservasi($post);
              ...
              if($total_seat == 1){
                  ...
                  foreach ($list_kursi as $key => $nomor_kursi) {
                    ...
                    $data_reservasi_list = array(
                      ...
                      'metode_pembayaran_tiket'=>strtoupper($post->metode_pembayaran),
                      'created_date'=>$this->waktu_skr,
                    );
