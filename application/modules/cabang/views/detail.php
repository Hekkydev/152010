    ...
    <div class="row">
      <div class="col-lg-12">
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <input type="text" name="kode_cabang" value="<?php echo $cabang->kode_cabang;?>" class="form-control" readonly="">
            </div>
          </div>
          <div class="form-group">
            <label for="" class="col-sm-3 control-label">Nama Cabang</label>
            <div class="col-sm-9">
              <input type="text" name="nama_cabang" value="<?php echo $cabang->nama_cabang;?>" class="form-control" readonly="">
            </div>
          </div>
          <div class="form-group">
            <label for="" class="col-sm-3 control-label">Alamat Cabang</label>
            <div class="col-sm-9">
              <textarea name="alamat_cabang"  class="form-control" readonly=""><?php echo $cabang->alamat_cabang;?></textarea>
            </div>
          </div>
          <div class="form-group">
            <label for="" class="col-sm-3 control-label">Kota</label>
            <div class="col-sm-9">
              <select class="form-control" readonly="" name="kota">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <input type="text" name="no_telp_cabang" value="<?php echo $cabang->no_telp_cabang;?>" class="form-control" readonly="">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <input type="text" name="fax_cabang" value="<?php echo $cabang->fax_cabang;?>" class="form-control" readonly="">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <select class="form-control" readonly="" name="tipe_cabang">
          ...
          <div class="col-sm-offset-3 col-sm-8 no-padding">
            ...
            <a   href="<?php echo site_url('cabang/edit?sid='.$cabang->uuid_cabang.'')?>" class="btn bg-purple  btn-xs">EDIT</a>
          </div> <!-- /col -->
      </div>
    </div>
