...
<div class="form-user">
<?php echo form_open('sopir/update',$form); ?>
<?php
$IDhidden = array(
  'name'=>'id_sopir',
  'type'=>'hidden',
  'value'=>$sopir->uuid_sopir,
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="form-group">
            ...
            <div class="col-xs-9">
              <input type="text" name="kode_sopir" value="<?php echo $sopir->kode_sopir ?>" class="form-control" required="">
            </div>
          </div>
          <div class="form-group">
            <label for=""  class="col-xs-3 control-label">Nama Sopir</label>
            <div class="col-xs-9">
                <input type="text" name="nama_sopir" value="<?php echo $sopir->nama_lengkap ?>" class="form-control" required="" placeholder="masukan nama lengkap">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-xs-9">
                <input type="text" name="no_hp" value="<?php echo $sopir->no_hp ?>" class="form-control" required="">
            </div>
          </div>
         ...
         <div class="form-group">
           ...
           <div class="col-xs-9">
             <input type="text" name="no_ktp" value="<?php echo $sopir->no_ktp ?>" class="form-control" required="" placeholder="masukan no KTP">
           </div>
         </div>
         <div class="form-group">
           <label for="" class="col-xs-3 control-label">No.SIM</label>
           <div class="col-xs-9">
             <input type="text" name="no_sim" value="<?php echo $sopir->no_sim ?>" class="form-control" required="">
           </div>
         </div>
        ...
        <div class="form-group">
          <label for="" class="col-xs-3 control-label">Alamat</label>
            <div class="col-xs-9">
                <textarea name="alamat_sopir" class="form-control" required="" placeholder="masukan alamat lengkap"><?php echo $sopir->alamat_sopir ?></textarea>
            </div>
        </div>
