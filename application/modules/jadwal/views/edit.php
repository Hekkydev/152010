...
<div class="">
  <?php
  echo form_open('jadwal/update',$form);
    ...
    <div class="row">
      <div class="col-xs-offset-2 col-lg-7">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <input type="text" name="kode_atr" value="<?php echo $jadwal->kode_atr?>" class="form-control" >
            </div>
          </div>
		  <div class="form-group">
			<label class="col-sm-3 control-label">Tipe Jadwal</label>
			<div class="col-sm-9">
			    <?php if ($jadwal->tipe_jadwal == 1): ?>
            <div class="radio radio-red">
                      <input id="reguler" type="radio" name="tipe" value="1" checked="">
            ...
            <?php else: ?>
              ...
              <div class="radio radio-blue">
                        <input id="extra" type="radio" name="tipe" value="0" checked="">
                        <label for="extra"><span>EXTRA</span></label>
              </div> <!-- /radio -->
			    <?php endif; ?>
			</div>
            ...
            <div class="col-sm-9">
              <select class="<?php echo $form_control?>" name="id_jml_kursi">
                  <?php foreach ($jmlKursi as $jk): ?>
                    <?php if ($jadwal->id_jml_kursi == $jk->id_jml_kursi): ?>
                        <option value="<?php echo $jk->id_jml_kursi; ?>" selected=""><?php echo $jk->jumlah_kursi; ?> (<?php echo $jk->jumlah_kursi; ?> Kursi)</option>
                        <?php else: ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <select class="form-control"  name="id_status">
                  ...
                  <?php if ($jadwal->id_status == $s->id_status): ?>
            ...
            <div class="col-sm-9">
              <select class="form-control"  name="id_jenis_jadwal" id="id_jenis_jadwal">
                <?php foreach ($jenis_jadwal as $jj): ?>
                    <?php if ($jj->id_jenis_jadwal == $jadwal->id_jenis_jadwal): ?>
                        <option value="<?php echo $jj->id_jenis_jadwal?>" selected=""><?php echo $jj->tipe_jenis_jadwal ?></option>
                      <?php else: ?>
