<?php
$this->load->view('User/script_edit');
$form = array('class'=>'form-horizontal','id'=>'form-user','onSubmit'=>'return validasi_edit()');
...
<div class="row">
  ...
  <div class="col-lg-6">
      ...
      <div class="form-group">
            ...
            <div class="col-xs-7">
              <input type="text" name="no_reg" value="<?php echo $users->no_reg; ?>" class="form-control input-sm" >
            </div>
      </div>
      <div class="form-group">
            <label for="" class="control-label col-xs-5">No.KTP</label>
            <div class="col-xs-7">
              <input type="text" name="nomor_ktp" value="<?php echo $users->no_ktp ?>" class="form-control input-sm" >
            </div>
      </div>
      <div class="form-group">
            <label for="" class="control-label col-xs-5">Nama Lengkap</label>
            <div class="col-xs-7">
              <input type="text" name="nama_lengkap" value="<?php echo $users->nama_lengkap ?>" class="form-control input-sm" >
            </div>
      </div>
      <div class="form-group">
            <label for="" class="control-label col-xs-5">Alamat</label>
            <div class="col-xs-7">
              <textarea name="alamat_user" class="form-control input-sm" ><?php echo $users->alamat_user; ?></textarea>
            </div>
      </div>
      <div class="form-group">
            <label for="" class="control-label col-xs-5">No. Handphone</label>
            <div class="col-xs-7">
              <input type="text" name="no_hp" value="<?php echo $users->no_telp ?>" class="form-control input-sm" >
            </div>
      </div>
      <div class="form-group">
            <label for="" class="control-label col-xs-5">Email</label>
            <div class="col-xs-7">
              <input type="email" name="email" value="<?php echo $users->email ?>" class="form-control input-sm" >
            </div>
      </div>
  ...
  <div class="col-lg-6">
      ...
      <div class="form-group">
            ...
            <div class="col-xs-7">
              <input type="text" name="username" value="<?php echo $users->username ?>" class="form-control input-sm" >
            </div>
      </div>
      <div class="form-group">
  ...
  <div class="col-sm-offset-2 col-lg-8 no-padding col-center">
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
                <button class="btn  bg-purple btn-sm btn-block" name="simpan" value="OK" type="submit">Edit</button>
        </div>
