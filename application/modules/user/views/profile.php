      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="form-group">
                ...
                <div class="col-xs-8">
                  <input type="text" name="" value="<?php echo $usersLog->kode_user;?>" class="form-control input-sm" readonly="">
                </div>
          </div>
          <div class="form-group">
                <label for="" class="control-label col-xs-3">Nama Lengkap </label>
                <div class="col-xs-8">
                  <input type="text" name="" value="<?php echo $usersLog->nama_lengkap;?>" class="form-control input-sm" readonly="">
                </div>
          </div>
          <div class="form-group">
                <label for="" class="control-label col-xs-3">No.Reg Karyawan </label>
                <div class="col-xs-8">
                  <input type="text" name="" value="<?php echo $usersLog->no_reg;?>" class="form-control input-sm" readonly="">
                </div>
          </div>
          <div class="form-group">
                <label for="" class="control-label col-xs-3">No.KTP </label>
                <div class="col-xs-8">
                  <input type="text" name="" value="<?php echo $usersLog->no_ktp;?>" class="form-control input-sm" readonly="">
                </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
                ...
                <div class="col-xs-8">
                  <input type="text" name="" value="<?php echo $usersLog->email;?>" class="form-control input-sm" readonly="">
                </div>
          </div>
          <div class="form-group">
                <label for="" class="control-label col-xs-3">Alamat </label>
                <div class="col-xs-8">
                  <textarea class="form-control input-sm" readonly="" style="height:100px;"><?php echo $usersLog->alamat_user;?></textarea>
                </div>
          </div>
          <div class="form-group">
                <label for="" class="control-label col-xs-3">Cabang Login: </label>
                <div class="col-xs-8">
                  <select class="form-control input-sm" readonly="" name="">
          ...
          <div class="col-xs-offset-2 col-lg-8">
            <a href="<?php echo site_url('user/profile/edit')?>" class="btn btn-block bg-purple btn-md">Edit Profile</a>
          </div>
        </div>
