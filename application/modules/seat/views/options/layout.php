...
if($cek_block == TRUE):?>
    <?php if($cek_block->nomor_kursi == 0):?>
     <div class="col-lg-3" data-event="kursi" data-id="2" data-number="<?php echo $i;?>" align="center" style="background:blue; color:#FFF; margin:5px;height:100px;padding-top:40px;cursor:pointer;">
    Active : <?php print_r($cek_block->nomor_kursi);?>
    </div>
    <?php else:?>
    <div class="col-lg-3" data-event="kursi" data-layout="active" data-id="2" data-number="<?php echo $i;?>" align="center" style="background:purple; color:#FFF; margin:5px;height:100px;padding-top:40px;cursor:pointer;">
    Active : <?php print_r($cek_block->nomor_kursi);?>
    </div>
    <?php endif;?>
