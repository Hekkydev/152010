...
?>
  ...
  <div class="form-group">
    ...
    <div class="col-xs-5">
      <input type="text" name="kode_product" value="<?php ?>" readonly="" class="form-control">
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-xs-5">
      <input type="text" name="price_service" class="form-control" maxlength="10" data-inputmask="'alias': 'numeric', 'groupSeparator': '.', 'autoGroup': true" placeholder="0">
    </div>
  </div>
  <div class="form-group">
...
<?php $this->load->view('barbershop_service/script/script_add'); ?>
