<div class="panel">
    ...
    <div class="panel-body">
      ...
      <?php echo form_open('jurusan/entri',$form); ?>
      <input type="hidden" name="kode_atr_cek" >
        <div class="form-jurusan form-horizontal">
            ...
            <div class="form-group form-group-sm">
              ...
              <div class="col-xs-8">
                <input type="text" name="kode_jurusan" value="<?php echo $kode?>" class="form-control input-sm" readonly="">
              </div>
            </div>
              ...
              <div class="form-group form-group-sm">
                ...
                <div class="col-xs-8">
                  <input type="text" name="kode_atr" class="form-control input-sm" placeholder="Buat kode jurusan">
                  <p id="infokode"></p>
                </div>
              </div>
