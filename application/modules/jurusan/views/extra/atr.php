  ...
  <div class="row">
      ...
      <div class="col-lg-4">
          <div class="form-group">
            <a href="<?php echo site_url('jurusan/add')?>" class="btn btn-xs btn-outline bg-purple">Tambah Data</a>
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="input-group">
                <input type="text" id="keywords" placeholder="kode jurusan" onkeyup="searchFilter()" class="form-control input-sm">
