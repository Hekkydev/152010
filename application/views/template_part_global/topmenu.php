...
<div class="container-fluid">
    ...
    <div id="navbar-header">
      ...
      <a class="navbar-brand" >
          ...
          <span class="logo-text hidden-xs hidden-sm"><img src="<?php echo base_url()?>assets/img/logo-inverses.png" alt="" style="width:150px;  margin-top:-10px;"></span>
      </a> <!-- /navbar-brand -->
    ...
    <li class="btn-menu"><a ><i class="fa fa-podcast"></i> Cabang Login: <?php echo '('.$usersLog->kode_cabang.') '.$usersLog->nama_cabang?> </a></li>
