...
class Ajax_pagination{
    ...
    function create_links(){
        ...
        if ($num_pages == 1){
            $info = '<ul class="pagination pagination-sm"><li><a>  Menampilkan : ' . $this->total_rows.' Record </a></li></ul>';
            return $info;
        }
        ...
        if ($this->show_count){
            ...
            $info = '<li><a> Menampilkan ' . ( $curr_offset + 1 ) . ' - ' ;
            ...
            $info .= ' Dari ' . $this->total_rows . ' Record </a></li>';
            $output .= $info;
        }
